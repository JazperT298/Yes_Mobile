...
public class NewNewsfeedActivity extends AppCompatActivity {
    ...
    private void initializeUI () {
        ivBack = findViewById(R.id.iv_NewNewsfeedBack);
        ivImage = findViewById(R.id.iv_NewNewsfeedImage);
        ivGallery = findViewById(R.id.iv_NewNewsfeedGallery);
        ivAttach = findViewById(R.id.iv_NewNewsfeedAttach);
        ivSend = findViewById(R.id.iv_NewNewsfeedSend);
        etDetails = findViewById(R.id.tv_NewNewsfeedDetails);
