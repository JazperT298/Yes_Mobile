...
public class Student {
    ...
    public String getUser_suffixes() {
        return user_suffixes;
    }

    public void setUser_suffixes(String user_suffixes) {
        this.user_suffixes = user_suffixes;
    }
